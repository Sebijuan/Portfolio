                    ...
                    <div className="estudios-trabajos-content">
                        <div className="estudios">
                            ...
                            <div className="estudio-item">
                                <h4>Bachillerato Tecnológico ADA.ITS (2021-2023),Sevilla</h4>
                                <p>Proporcionó una sólida base en ciencias y tecnología.</p>
                            </div>
                            <div className="estudio-item">
                                <h4>Grado Superior de Desarrollo de Aplicaciones Web ADA.ITS (2023-2025),Sevilla</h4>
                        ...
                        <div className="trabajos">
                            ...
                            <div className="trabajo-item">
                                <h4>Teleoperador en Konecta (2023-2023),Sevilla </h4>
                                <p>Desarrollé habilidades de comunicación y atención al cliente.</p>
                            </div>
                            <div className="trabajo-item">
                                <h4>Camarero de boda en Hacienda el Vizir (2022-2022),Sevilla</h4>
